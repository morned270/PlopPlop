...
public class Quiz3Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView getcourse = (TextView)findViewById(R.id.quiz_course); //퀴즈 난이도 쓸 textview 선언

        final TextView quiz_text = (TextView)findViewById(R.id.quiz_text);    //문제와 문제의 답 버튼들 선언
        final Button btn_ans_1 = (Button)findViewById(R.id.btn_ans_1);
        final Button btn_ans_2 = (Button)findViewById(R.id.btn_ans_2);
        final Button btn_ans_3 = (Button)findViewById(R.id.btn_ans_3);
        final Button btn_ans_4 = (Button)findViewById(R.id.btn_ans_4);
        ...
        final String[] arr_text = getResources().getStringArray(R.array.quiz_text); /*quiz_aow 불러오기*/
        final String[] arr_ans1 = getResources().getStringArray(R.array.ans_1);
        final String[] arr_ans2 = getResources().getStringArray(R.array.ans_2);
        final String[] arr_ans3 = getResources().getStringArray(R.array.ans_3);
        final String[] arr_ans4 = getResources().getStringArray(R.array.ans_4);
        final int[] arr_anslist = getResources().getIntArray(R.array.anslist);
